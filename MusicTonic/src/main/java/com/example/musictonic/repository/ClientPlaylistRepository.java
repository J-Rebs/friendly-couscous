 ...
 */
public interface ClientPlaylistRepository extends JpaRepository<ClientPlaylist, Long> {

  List<ClientPlaylist> findAllByClient(Client client);

  List<ClientPlaylist> findAllByPlaylist(Playlist p);
}
