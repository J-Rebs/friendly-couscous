...
public class Client3ControllerTest {
  ...
  void init() {
    ...
    song = new Song(1L, "pathetique sonata", 20, "Beethoven", "n/a", 3000);
    song2 = new Song(2L, "waldstein sonata", 20, "Baethoven", "n/a", 2000);
    song3 = new Song(3L, "appassionata sonata", 25, "Beethoven", "n/a", 1000);
